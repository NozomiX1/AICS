...
class MNIST_MLP(object):
    def __init__(self, batch_size=100, input_size=784, hidden1=64, hidden2=32, out_classes=10, lr=0.005, max_epoch=1, print_iter=100):
...
def build_mnist_mlp(param_dir='weight.npy'):
    h1, h2, lr, e = 1024, 512, 0.005, 10
    mlp = MNIST_MLP(batch_size=10000, hidden1=h1, hidden2=h2, lr=lr, max_epoch=e)
    mlp.load_data()
    mlp.build_model()
    mlp.init_model()
    #mlp.train()
    #mlp.save_model('mlp-%d-%d-%d-%depoch.npy' % (h1, h2, lr, e))
