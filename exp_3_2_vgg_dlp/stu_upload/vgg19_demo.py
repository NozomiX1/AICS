...
class VGG19(object):
    ...
    def build_model(self, 
        ...
        # loading quant params before creating layers, you should run through the net with cpu and get positions and
        # scales used for quantizing input data. you can get quant params by using pycnml.QuantTool only conv and mlp
        # layer need to be quantized in this experiment these quant params have already been created and saved into
        # local files.
